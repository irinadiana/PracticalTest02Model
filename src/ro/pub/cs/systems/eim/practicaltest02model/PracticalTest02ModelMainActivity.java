package ro.pub.cs.systems.eim.practicaltest02model;
...
public class PracticalTest02ModelMainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_practical_test02model_main);
		
		serverPortEditText = (EditText)findViewById(R.id.port_server_edit_text);
        connectButton = (Button)findViewById(R.id.connect_button);
        connectButton.setOnClickListener(connectButtonClickListener);

        clientAddressEditText = (EditText)findViewById(R.id.address_edit_text);
        clientPortEditText = (EditText)findViewById(R.id.port_client_edit_text);
        cityEditText = (EditText)findViewById(R.id.city_edit_text);
        informationTypeSpinner = (Spinner)findViewById(R.id.data_spinner);
        getWeatherForecastButton = (Button)findViewById(R.id.weather);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.practical_test02_model_main, menu);
		return true;
	}
